...
if __name__ == "__main__":
    print("=" * 100)
    print("Training and Inference codes used in Demo 1, using the following parameters for running:")
    print("Change the PATH in load_data() function")
    print('''-wn -qt -c "3, 6" -s 4 -l 0.01 -ql 0.0001 -e 10 --device cpu -nn "2, 2" -qa "1 1 1 1, 1 1" -r "checkpoint_8_0.9573.pth.tar" -t -deb -ib 1''')
