...
CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -wn -nq -c "3, 8" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/wnnq1_38_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -wn -nq -c "3, 8" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/wnnq2_38_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -wn -nq -c "3, 8" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/wnnq3_38_bin.res 2>&1 &
sleep 1

CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -nq -c "3, 8" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/nq1_38_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -nq -c "3, 8" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/nq2_38_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -nq -c "3, 8" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/nq3_38_bin.res 2>&1 &
sleep 1


CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -tb 16 -nn "8, 3" -wn -nq -c "1, 3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/wnnq1_136_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -tb 16 -nn "8, 3" -wn -nq -c "1, 3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/wnnq2_136_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -tb 16 -nn "8, 3" -wn -nq -c "1, 3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/wnnq3_136_bin.res 2>&1 &
sleep 1

CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -tb 16 -nn "8, 3" -nq -c "1, 3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/nq1_136_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -tb 16 -nn "8, 3" -nq -c "1, 3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/nq2_136_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -tb 16 -nn "8, 3" -nq -c "1, 3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/nq3_136_bin.res 2>&1 &
sleep 1
wait
...
#
#
#CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -tb 16 -nn "8, 3" -c "1, 3, 6" -s 4 -l 0.1 -e 30 -m "10, 20" -chk > log/q7_136_bin.res 2>&1 &
#sleep 1
#CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -tb 16 -nn "8, 3" -c "1, 3, 6" -s 4 -l 0.1 -e 30 -m "10, 20" -chk > log/q8_136_bin.res 2>&1 &
#sleep 1
#CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -tb 16 -nn "8, 3" -c "1, 3, 6" -s 4 -l 0.1 -e 30 -m "10, 20" -chk > log/q9_136_bin.res 2>&1 &
#sleep 1
#
#CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -tb 16 -nn "8, 3" -c "1, 3, 6" -s 4 -l 0.1 -e 30 -m "10, 20" -chk > log/q4_136_bin.res 2>&1 &
#sleep 1
#CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -tb 16 -nn "8, 3" -c "1, 3, 6" -s 4 -l 0.1 -e 30 -m "10, 20" -chk > log/q5_136_bin.res 2>&1 &
#sleep 1
#CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -tb 16 -nn "8, 3" -c "1, 3, 6" -s 4 -l 0.1 -e 30 -m "10, 20" -chk > log/q6_136_bin.res 2>&1 &
#sleep 1
#wait



#CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -qa "1 1 1 1, -1 -1" -wn -qt -c "3, 8" -s 4 -l 0.1 -ql 0.1 -e 30 -m "10, 20" -chk > log/real_wnqt1_38.res 2>&1 &
#sleep 1
#CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -qa "1 1 1 1, -1 -1" -wn -qt -c "3, 8" -s 4 -l 0.1 -ql 0.1 -e 30 -m "10, 20" -chk > log/real_wnqt2_38.res 2>&1 &
#sleep 1
#CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -qa "1 1 1 1, -1 -1" -wn -qt -c "3, 8" -s 4 -l 0.1 -ql 0.1 -e 30 -m "10, 20" -chk > log/real_wnqt3_38.res 2>&1 &
#sleep 1
#CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -qa "1 1 1 1, -1 -1" -wn -qt -c "3, 8" -s 4 -l 0.1 -ql 0.1 -e 30 -m "10, 20" -chk > log/real_wnqt4_38.res 2>&1 &
#sleep 1
#wait
#
...
#
#
CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -nq -c "3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/nq1_36_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -nq -c "3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/nq2_36_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=1 python exe_mnist.py -bin -nq -c "3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/nq3_36_bin.res 2>&1 &
sleep 1
...
CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -wn -nq -c "3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/wnnq1_36_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -wn -nq -c "3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/wnnq2_36_bin.res 2>&1 &
sleep 1
CUDA_VISIBLE_DEVICES=0 python exe_mnist.py -bin -wn -nq -c "3, 6" -s 4 -l 0.001 -e 30 -m "10, 20" -chk > log/wnnq3_36_bin.res 2>&1 &
sleep 1
